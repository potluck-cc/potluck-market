// courtesy of: https://github.com/akveo/kittenTricks/blob/af8349824116d0a254ad5228e74f2baed8837f95/src/components/common/avoidKeyboard.component.tsx
...
export default class AvoidKeyboard extends React.Component<AvoidKeyboardProps> {
  ...
  private createTranslateAnimation = (params: {
    offset: number;
